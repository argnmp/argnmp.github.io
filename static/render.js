...
function __wbg_adapter_24(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h18297413020c7fd3(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_102(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h2bb9fc9ae3bbd90e(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class Ground {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Ground.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_ground_free(ptr);
    }
    /**
    * @returns {Ground}
    */
    static new() {
        const ret = wasm.ground_new();
        return Ground.__wrap(ret);
    }
    /**
    * @param {string} url
    ...
    */
    add(url) {
        ...
        const ret = wasm.ground_add(this.__wbg_ptr, ptr0, len0);
    ...
    */
    add_many(urls) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ground_add_many(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {string} url
    * @param {boolean} do_transition
    * @returns {Promise<void>}
    */
    load(url, do_transition) {
        const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.ground_load(this.__wbg_ptr, ptr0, len0, do_transition);
        return takeObject(ret);
    }
    /**
    * @returns {Promise<void>}
    */
    print_cache() {
        const ret = wasm.ground_print_cache(this.__wbg_ptr);
        return takeObject(ret);
    }
}
/**
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_all_93840200f70d9194 = function(arg0) {
